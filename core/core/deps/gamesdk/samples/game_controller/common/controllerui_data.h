...
class ControllerUIData {
 public:
  ...
  static const UITextureInfo &getUIButtonTextures(
  ...
  static ControllerButtonInfo &getControllerButtonInfo(
      const ControllerUIButtons uiButton);
  ...
  static void getTriggerRectExtents(const ControllerUIButtons uiButton,
