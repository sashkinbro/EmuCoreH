...
constexpr float ROW_BUTTON_SYSTEM_BASE_Y =
    ROW_QUAD_AND_STICKS_BASE_Y - 128.0f;  // 144.0f;
constexpr float ROW_BUTTON_TRIGGER_BASE_Y =
    ROW_QUAD_AND_STICKS_BASE_Y - 112.0f;  // 128.0f;
...
constexpr float BUTTON_QUAD_BOTTOM_Y =
    BUTTON_QUAD_BASE_Y + BUTTON_QUAD_Y_ADJUST;
...
constexpr float BUTTON_L2_Y =
    ROW_BUTTON_TRIGGER_BASE_Y - BUTTON_TRIGGER_ADJUST_Y;
...
ControllerButtonInfo controllerButtonInfo[UIBUTTON_COUNT] = {
    {{BUTTON_QUAD_BOTTOM_X, BUTTON_QUAD_BOTTOM_Y},
     PADDLEBOAT_BUTTON_A,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_QUAD_RIGHT_X, BUTTON_QUAD_RIGHT_Y},
     PADDLEBOAT_BUTTON_B,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_QUAD_LEFT_X, BUTTON_QUAD_LEFT_Y},
     PADDLEBOAT_BUTTON_X,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_QUAD_TOP_X, BUTTON_QUAD_TOP_Y},
     PADDLEBOAT_BUTTON_Y,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_QUAD_BOTTOM_X, BUTTON_QUAD_BOTTOM_Y},
    ...
    {{BUTTON_QUAD_TOP_X, BUTTON_QUAD_TOP_Y},
     ...
     UIBUTTON_STATE_IDLE,
     false},
    {{BUTTON_L1_X, BUTTON_L1_Y},
     PADDLEBOAT_BUTTON_L1,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_L2_X, BUTTON_L2_Y},
     PADDLEBOAT_BUTTON_L2,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_R1_X, BUTTON_R1_Y},
     PADDLEBOAT_BUTTON_R1,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_R2_X, BUTTON_R2_Y},
     PADDLEBOAT_BUTTON_R2,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_SELECT_X, BUTTON_SELECT_Y},
     PADDLEBOAT_BUTTON_SYSTEM,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_MODE_X, BUTTON_MODE_Y},
    ...
    {{DPAD_UP_X, DPAD_UP_Y},
     ...
     UIBUTTON_STATE_IDLE,
     true},
    {{DPAD_LEFT_X, DPAD_LEFT_Y},
     PADDLEBOAT_BUTTON_DPAD_LEFT,
     UIBUTTON_STATE_IDLE,
     true},
    {{DPAD_DOWN_X, DPAD_DOWN_Y},
     PADDLEBOAT_BUTTON_DPAD_DOWN,
     UIBUTTON_STATE_IDLE,
     true},
    {{DPAD_RIGHT_X, DPAD_RIGHT_Y},
     PADDLEBOAT_BUTTON_DPAD_RIGHT,
     UIBUTTON_STATE_IDLE,
     true}};

ControllerButtonInfo controllerButtonInfo_ArcadeStick[UIBUTTON_COUNT] = {
    {{AS_BUTTON_A_X, AS_BUTTON_A_Y},
     PADDLEBOAT_BUTTON_A,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_B_X, AS_BUTTON_B_Y},
     PADDLEBOAT_BUTTON_B,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_X_X, AS_BUTTON_X_Y},
     PADDLEBOAT_BUTTON_X,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_Y_X, AS_BUTTON_Y_Y},
     PADDLEBOAT_BUTTON_Y,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_QUAD_BOTTOM_X, BUTTON_QUAD_BOTTOM_Y},
    ...
    {{BUTTON_QUAD_TOP_X, BUTTON_QUAD_TOP_Y},
     ...
     UIBUTTON_STATE_IDLE,
     false},
    {{AS_BUTTON_L1_X, AS_BUTTON_L1_Y},
     PADDLEBOAT_BUTTON_L1,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_L2_X, AS_BUTTON_L2_Y},
     PADDLEBOAT_BUTTON_L2,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_R1_X, AS_BUTTON_R1_Y},
     PADDLEBOAT_BUTTON_R1,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_BUTTON_R2_X, AS_BUTTON_R2_Y},
     PADDLEBOAT_BUTTON_R2,
     UIBUTTON_STATE_IDLE,
     true},
    {{BUTTON_SELECT_X, BUTTON_SELECT_Y},
    ...
    {{BUTTON_START_X, BUTTON_START_Y},
     ...
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_DPAD_UP_X, AS_DPAD_UP_Y},
     PADDLEBOAT_BUTTON_DPAD_UP,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_DPAD_LEFT_X, AS_DPAD_LEFT_Y},
     PADDLEBOAT_BUTTON_DPAD_LEFT,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_DPAD_DOWN_X, AS_DPAD_DOWN_Y},
     PADDLEBOAT_BUTTON_DPAD_DOWN,
     UIBUTTON_STATE_IDLE,
     true},
    {{AS_DPAD_RIGHT_X, AS_DPAD_RIGHT_Y},
     PADDLEBOAT_BUTTON_DPAD_RIGHT,
     UIBUTTON_STATE_IDLE,
     true}};
}  // namespace

ImVec2 ControllerUIData::getButtonQuadPosition(
    const ControllerUIButtons dpadButton) {
  switch (dpadButton) {
...
void ControllerUIData::LoadControllerUIData() {
  if (!uiDataInitialized) {
    ...
    stickTextures.textureHandles[UISTICK_STATE_ACTIVE] =
        TextureAssetLoader::loadTextureAsset(stickDefinition.assetName_Active,
                                             &stickTextures.textureWidth,
    ...
    stickTextures.textureHandles[UISTICK_STATE_IDLE] =
        TextureAssetLoader::loadTextureAsset(stickDefinition.assetName_Idle,
                                             nullptr, nullptr);
...
const UITextureInfo &ControllerUIData::getUIButtonTextures(
...
ControllerButtonInfo &ControllerUIData::getControllerButtonInfo(
    const ControllerUIButtons uiButton) {
  return controllerButtonInfo[uiButton];
}

ControllerButtonInfo &ControllerUIData::getControllerButtonInfo_ArcadeStick(
    const ControllerUIButtons uiButton) {
...
float ControllerUIData::getStickScale() { return STICK_SCALE; }

void ControllerUIData::getTriggerRectExtents(const ControllerUIButtons uiButton,
