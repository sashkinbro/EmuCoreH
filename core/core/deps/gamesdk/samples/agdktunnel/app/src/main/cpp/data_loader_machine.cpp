...
DataLoaderStateMachine::DataLoaderStateMachine(bool isCloudSaveEnabled,
                                               char *savePath) {
...
DataLoaderStateMachine::~DataLoaderStateMachine() { delete mSaveFileName; }

int DataLoaderStateMachine::getTotalSteps() { return DATA_LOADED; }

int DataLoaderStateMachine::getStepsCompleted() { return mCurrentState; }
...
int DataLoaderStateMachine::getLevelLoaded() { return mLevelLoaded; }
