...
void UiScene::OnPointerDown(int /*pointerId*/,
...
void UiScene::OnPointerMove(int /*pointerId*/,
                            const struct PointerCoords *coords) {
...
void UiScene::OnPointerUp(int /*pointerId*/,
                          const struct PointerCoords *coords) {
  if (!coords->isScreen || mWaitScreen) {
    return;
  }
...
void UiWidget::Render(TrivialShader * /*trivialShader*/,
                      TextRenderer *textRenderer, ShapeRenderer *shapeRenderer,
