...
public class AGDKTunnelActivity extends GameActivity {
  ...
  private void setInputContext(int contextIndex) {
    ...
    Log.e(TAG,
        String.format(
            "can't find InputContext with id %d on attempt to change of context", contextIndex));
  }
  ...
  private void setInputContext(InputSDKProvider.InputContextIds context) {
    ...
    switch (context) {
      ...
      case INPUT_CONTEXT_PAUSE_MENU:
        ...
        break;
      default:
        Log.e(TAG, "can't match the requested InputContext on attempt to change of context");
    }
  }
