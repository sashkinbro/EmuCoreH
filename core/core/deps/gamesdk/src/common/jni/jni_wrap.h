...
class Object {
 public:
  ...
  int CallVIMethod(const char* name) { return obj_.CallIntMethod(name, "()I"); }
  ...
  Object CallOOOMethod(const char* name, const char* parameterClassA,
    ...
    str << "(L" << parameterClassA << ";L" << parameterClassB << ";)L"
        << returnClass << ";";
    jobject o = obj_.CallObjectMethod(name, str.str().c_str(), (jobject)a.obj_,
                                      (jobject)b.obj_);
    return Object(o);
  }
  int CallSIIMethod(const char* name, const char* a, const int b) {
    ...
    return obj_.CallIntMethod(name, "(Ljava/lang/String;I)I", String(a).J(), b);
  }
  ...
  Object CallSOMethod(const char* name, const char* a,
    ...
    jobject o = obj_.CallObjectMethod(name, str.str().c_str(), String(a).J());
    return Object(o);
  }
...
class HttpURLConnection : public URLConnection {
 public:
  ...
  void setReadTimeout(int timeout) { CallIVMethod("setReadTimeout", timeout); }
 ...
 public:
  ...
  URLConnection openConnection() {
    return URLConnection(Object(
        obj_.CallObjectMethod("openConnection", "()Ljava/net/URLConnection;")));
  }
};
...
class DisplayMetrics : public java::Object {
 public:
  ...
  DisplayMetrics() : java::Object("android/util/DisplayMetrics", "()V") {}
...
class Display : public java::Object {
 public:
  ...
  void getMetrics(util::DisplayMetrics& displayMetrics) {
    CallOVMethod("getMetrics", "android/util/DisplayMetrics", displayMetrics);
  }
};
...
class WindowManager : public java::Object {
 public:
  ...
  Display getDefaultDisplay() {
    return CallVOMethod("getDefaultDisplay", "android/view/Display");
  }
};
...
class FeatureInfo : public java::Object {
 public:
  FeatureInfo(java::Object&& o) : java::Object(std::move(o)) {
    jni::String jname(
        (jstring)obj_.GetObjectField("name", "Ljava/lang/String;").ObjNewRef());
...
class PackageInfo : public java::Object {
 public:
  ...
  std::vector<Signature> signatures() const {
    auto env = Env();
    auto jsigs =
        obj_.GetObjectField("signatures", "[Landroid/content/pm/Signature;");
...
class Context : public java::Object {
 public:
  ...
  Context(jobject o) : java::Object(o) { obj_.Cast("android/content/Context"); }
  ...
  android::view::WindowManager getWindowManager() {
    return CallVOMethod("getWindowManager", "android/view/WindowManager");
  }
 ...
 public:
  static uint64_t getNativeHeapAllocatedSize() {
    ...
    if (env != nullptr) {
      ...
      jclass clz = obj;
      jmethodID method =
          env->GetStaticMethodID(clz, "getNativeHeapAllocatedSize", "()J");
      if (method != NULL)
...
class ActivityManager : public java::Object {
 public:
  ...
  int32_t getLargeMemoryClass() { return CallVIMethod("getLargeMemoryClass"); }
  ...
  java::util::List getHistoricalProcessExitReasons(std::string& packageName,
    ...
    return CallSIIOMethod("getHistoricalProcessExitReasons",
                          packageName.c_str(), pid, maxNum, "java/util/List");
  }
};
