...
object GamepadManager {
    ...
    fun mappableButtonActions(): List<MappableButtonAction> =
        mappableActions.filterNot { it.id in setOf("l2", "r2", "l3", "r3") }
    ...
    @SuppressLint("NewApi")
    private fun isExternalDevice(device: InputDevice): Boolean =
    ...
    internal fun assignConnectedGamepadSlots(
        ...
        preferExternalGamepadAsPlayerOne: Boolean = false,
