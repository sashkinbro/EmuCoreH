package com.sbro.emucoreh.feedback
...
class FeedbackUploadWorker(
    ...
    private fun upload(directory: File, feedback: QueuedFeedback): Int {
        ...
        val boundary = "EmuCoreH-${UUID.randomUUID()}"
        val connection = (endpoint.openConnection() as HttpURLConnection).apply {
            ...
            // The shared EmuCoreH feedback worker authenticates with X-EmuCoreHX-Key.
            setRequestProperty("X-EmuCoreHX-Key", BuildConfig.FEEDBACK_API_KEY)
            setRequestProperty("User-Agent", "EmuCoreH/${BuildConfig.VERSION_NAME} (Android)")
        }
    ...
    private fun diagnostics(): Map<String, String> {
        ...
        return linkedMapOf(
            ...
            "coreVersion" to "$coreName $coreVersion",
