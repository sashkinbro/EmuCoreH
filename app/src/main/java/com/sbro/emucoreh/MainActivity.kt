...
import com.sbro.emucoreh.core.AppLocaleManager
import com.sbro.emucoreh.core.GamepadManager
import com.sbro.emucoreh.core.NativeApp
import com.sbro.emucoreh.core.PlayInAppReviewManager
...
import com.sbro.emucoreh.navigation.AppNavigation
import com.sbro.emucoreh.ui.common.GamepadUiInputRouter
import com.sbro.emucoreh.ui.theme.EmuCoreHTheme
...
open class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (preferences.getProUnlockedSync()) {
            setTheme(R.style.Theme_EmuCoreH_Splash_Pro)
        }
        ...
        setContent {
            ...
            CompositionLocalProvider(
                ...
                com.sbro.emucoreh.ui.common.LocalGameCoverAspectRatio provides
    ...
    private fun recordCompletedEmulationSession(
        ...
        val app = application as EmuCoreHApp
        ...
        PlayInAppReviewManager.request(this) { result ->
            ...
            when (result) {
                PlayInAppReviewManager.Result.COMPLETED -> {
                    (application as EmuCoreHApp).applicationScope.launch {
